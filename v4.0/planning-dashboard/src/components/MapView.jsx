...
import { MapContainer, TileLayer, GeoJSON, Marker, Polyline, useMap, useMapEvents, Popup } from "react-leaflet";
...
const MapView = ({ gpBoundary, roads, infraNodes, selectedInfra, setSelectedInfra, customerLocation, setCustomerLocation, routeInfo, isLoading }) => {
                ...
                {Array.isArray(infraNodes) && infraNodes.map((node, idx) => {
                    ...
                    return (
                        <Marker
                            ...
                            icon={selectedInfra?.id === node.id ? amberIcon : redIcon}
                            eventHandlers={{
